...
const TAB_GROUPS = [
  ...
  },
  {
    ...
    tabs: [
      { id: "charts-all",  label: "Gráficos",           component: ChartsSection },
    ],
  },
  {
    id: "ui",
      ...
      <div className="border-b border-border bg-card sticky top-0 z-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-3">
            <div>
              <h1 className="text-lg font-bold tracking-tight text-foreground">Biblioteca de Componentes</h1>
              <p className="text-xs text-muted-foreground">Sistema de design completo e reutilizável</p>
            </div>
