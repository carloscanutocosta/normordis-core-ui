    ...
    <div className="space-y-8">
      <Card>
        ...
        <CardContent className="space-y-8">
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-3">Simples</p>
            <AreaChartComponent />
          </div>
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-3">Empilhado</p>
      ...
      <Card>
        ...
        <CardContent className="space-y-8">
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-3">Vertical</p>
            <BarChartComponent />
          </div>
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-3">Horizontal</p>
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-3">Pie</p>
            <PieChartComponent />
          </div>
          <div>
            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-3">Donut</p>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={label} className="flex items-center gap-4 py-2 border-b border-border last:border-0">
                ...
                <Sparkline data={sparkData.map((v, i) => ({ value: v + i * (trend > 0 ? 1 : -0.5) }))} dataKey="value" color={color} showTrend />
                <Badge className={trend > 0 ? "bg-green-100 text-green-700" : trend < 0 ? "bg-red-100 text-red-700" : "bg-muted text-muted-foreground"}>
                  {trend > 0 ? "+" : ""}{trend}%
                </Badge>
              </div>
            ))}
