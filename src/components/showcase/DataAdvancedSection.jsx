    ...
    <div className="space-y-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Quadro com colunas e cartões arrastáveis (drag-and-drop)
          </CardDescription>
        </CardHeader>
        <CardContent>
          <KanbanBoard />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Tabela com edição inline — clique numa célula para editar
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Mapa interactivo com marcadores (OpenStreetMap via react-leaflet)
          </CardDescription>
        </CardHeader>
        <CardContent>
          <MapView />
