...
function FileIcon({ type }) {
  ...
  if (type?.includes("pdf") || type?.includes("text")) return <FileText className="w-4 h-4 text-primary" />;
      ...
      >
        ...
        <div>
          <p className="text-sm font-medium text-foreground">
            Arraste arquivos ou <span className="text-primary underline underline-offset-2">clique para selecionar</span>
          </p>
