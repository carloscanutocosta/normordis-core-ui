...
const variants = {
  ring: ({ size, color }) => (
    <div className={cn('rounded-full border-2 border-t-transparent animate-spin', color, size)} />
  ),
  dots: ({ size, color }) => (
  ...
  pulse: ({ size, color }) => <div className={cn('rounded-full animate-pulse', color, size)} />,
  bars: ({ size, color }) => (
